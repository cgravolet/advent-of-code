...
func TestParseInputPuzzle202216(t *testing.T) {
	...
	got, _ := parseInputPuzzle202216(sample16)
...
func TestSolvePuzzle202216Part1(t *testing.T) {
	want := 1651
	got := solvePuzzle202216Part1(sample16)
...
func TestSolvePuzzle202216Part2(t *testing.T) {
	want := 1707
	got := solvePuzzle202216Part2(sample16)
