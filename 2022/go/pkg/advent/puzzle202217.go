...
func (a *AdventOfCode2022) Puzzle202217(input string) {
	part1 := solvePuzzle202217Part1(input)
	part2 := solvePuzzle202217Part2(input)
	fmt.Printf("Part 1: %d\n", part1)
	fmt.Printf("Part 2: %d\n", part2)
}
...
func solvePuzzle202217Part1(input string) int {
	rockCount := 2022
...
func solvePuzzle202217Part2(input string) int {
